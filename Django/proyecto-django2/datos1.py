...
#     print("Nombre: %s | Parroquia: %s | Codigo Division Politica: %s" % (r.Establecimiento.nombre_e, \
#         r.Parroquia.nombre, r.Parroquia.cod_division_politica))



establecimientos2 = session.query(Establecimiento, Provincia, Parroquia, Canton).join(Establecimiento).\
